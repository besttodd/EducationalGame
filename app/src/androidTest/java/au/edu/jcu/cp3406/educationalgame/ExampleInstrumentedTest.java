...
public class ExampleInstrumentedTest {
    ...
    public void databaseReadandWrite() {
        ...
        cursor = db.query("HIGHSCORES", new String[] {"SCORE"},
        ...
        try {
            ...
            cursor = db.query("HIGHSCORES", new String[] {"DATE", "DIFFICULTY", "SCORE"},
                    null, null, null, null, "SCORE"+ " DESC");

            if (cursor.moveToFirst()) {
                do { dateList.add(cursor.getString(cursor.getColumnIndex("DATE")));
